...
function displayCurrentWeather(currentWeatherData) {
  ...
  resultDiv.append(weatherInfoDiv);
    ...
    // Ändra bakgrundsfärgen baserat på temperatur
    let temperature = currentWeatherData.temperature;
    let body = document.body;
    if (temperature <= 0) {
        body.style.backgroundColor = '#85c1e9'; // Ljusblå för kallt väder
    } else if (temperature > 0 && temperature <= 20) {
        body.style.backgroundColor = '#f7dc6f'; // Ljusgul för milt väder
    } else {
        body.style.backgroundColor = '#e74c3c'; // Ljusröd för varmt väder
    }
